package br.com.hellodev.moviestreaming.presenter.components.bottom.sheet.delete
...
fun BottomSheetDelete(
    ...
    Column(
        ...
        Text(
            text = stringResource(R.string.label_title_bottom_sheet_delete_movie),
            style = TextStyle(
                fontSize = 24.sp,
                lineHeight = 28.8.sp,
        ...
        Text(
            text = stringResource(R.string.label_message_bottom_sheet_delete_movie),
            style = TextStyle(
                fontSize = 20.sp,
                lineHeight = 24.sp,
                fontFamily = UrbanistFamily,
        ...
        Row(
            ...
            SecondaryButton(
                modifier = Modifier
                    .weight(1f),
                text = stringResource(R.string.label_cancel_button_bottom_sheet_delete_movie),
            ...
            PrimaryButton(
                modifier = Modifier
                    .weight(1f),
                text = stringResource(R.string.label_confirm_button_bottom_sheet_delete_movie),
